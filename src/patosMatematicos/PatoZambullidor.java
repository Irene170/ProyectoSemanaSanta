 ...
 */
	...
	@Override
	/**
	 * Devuelve una cadena de caracteres de los atributos de la clase Pato Zambllidor 
	 */
	public String toString() {
		return "PatoZambullidor [nombre=" + nombre + ", edad=" + edad + ", color=" + color + ", salud=" + salud + "]";
	}
/** 
 * Método para resolver una ecuación lineal de primer grado de la forma "ax + b= 0"
 * 
